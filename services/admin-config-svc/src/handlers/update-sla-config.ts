...
import { CONFIG_KEYS, SLAConfig } from '../types/config';
...
export const handler = async (
  ...
  try {
    logger.info('Updating SLA tiers configuration', { event });
    ...
    logger.info('SLA configuration updated successfully', {
